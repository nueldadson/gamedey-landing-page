...
const Hero = () => {
    ...
    return (
        <div  data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200" id="home" className="aos-init relative flex flex-col font-bold justify-center items-center w-full  min-h-screen  px-4 lg:px-24 md:px-24  py-24 lg:py-24 md:py-24 ">
