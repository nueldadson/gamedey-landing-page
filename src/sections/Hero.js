...
function Hero () {
    ...
    return (
        <div id="home" className="relative flex flex-col font-bold justify-center items-center w-full  min-h-screen  px-4 lg:px-24 md:px-24  py-24 lg:py-24 md:py-24 " >
                        <img src={heroIMG} alt="Hero Image" class="  lg:w-2/6 md:w-2/3 w-5/6  mb-2 pt-8" data-aos="fade-up" />
                        <h1 className="text-2xl md:text-3xl lg:text-4x text-center px-4 md:px-24 lg:px-60 py-4 md:py-2 lg:py-2 mb-4 md:mb-6 lg:mb-8" data-aos="fade-up">
                        ...
                        {/* <Slide  direction="up" duration="800" className="herosideimg1"> */}
                            {/* <img src={heroIMG2} alt="" className="img11" data-aos="fade-up"/> */}
                        {/* </Slide> */}
                        {/* <Slide  direction="up" duration="800" className="herosideimg2" > */}
                            {/* <img src={heroIMG3} alt="" className="img11" data-aos="fade-up"/> */}
                        {/* </Slide> */}
                        <br />  <br />
                    </div>
    )
